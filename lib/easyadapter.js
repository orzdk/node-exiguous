...
module.exports = class easyAdapter {
    ...
    #idSupervisor = async (query) => {
        ...
        let r = {}, newquery={};
        let fetch_request = { method: "POST", body: JSON.stringify({"masterid": query.masterid}), headers: {"Content-Type": "application/json" }};
    ...
    easyAdapter = async (adapterin, request) => {
        ...
        try {
            ...
            log("return:" + adapterin + ":output:" + mappedOutput);
            log("~");
